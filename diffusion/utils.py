...
DATASET_ROOT = os.getenv('DATASET_ROOT', '/projects/katefgroup/datasets')
...
COCO_DATASET_ROOT = os.getenv('COCO_DATASET_ROOT', '/projects/katefgroup/datasets/coco')
NYUDEPTHv2_DATASET_ROOT = os.getenv('NYUDEPTHv2_DATASET_ROOT', '/projects/katefgroup/datasets/nyuv2_depth/nyu_data')
...
def get_classes_templates(dataset) -> tuple:
    ...
    return entry["classes"], classes_dict, templates